...
#ifndef _ERPC_UART_CUBEMX_TRANSPORT_H_
#define _ERPC_UART_CUBEMX_TRANSPORT_H_
...
public:
     ...
     * @brief Constructor.
     *
     * @param[in] uartHandle CubeMX uart.
     */
    UartTransport(UART_HandleTypeDef *uartHandle);
    ...
    erpc_status_t handShaking(void);


protected:
    UART_HandleTypeDef *m_uartHandle; /*!< Access structure of the USART Driver */
...
#endif /* _ERPC_UART_CUBEMX_TRANSPORT_H_ */
